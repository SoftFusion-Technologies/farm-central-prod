...
function Recipes() {
    return (
        <div id='recipes' className='relative' >
            <h1 className="font-lora text-3xl sm:text-3xl md:text-4xl lg:text-5xl text-center text-darkcyan mt-5 " data-aos="fade-down">Pasos para un correcto Skincare</h1>
            ...
            <h2 className="font-lora text-3xl sm:text-3xl md:text-4xl lg:text-5xl text-center text-keppel mb-10 mt-5" data-aos="fade-down">Recomendaciones</h2>
                 <Prodskincare />
        </div>
    )
}
